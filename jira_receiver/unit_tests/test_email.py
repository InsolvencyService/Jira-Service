...
class TestEmailRenderer(unittest.TestCase):
    ...
    def test_email_content_rendered_from_model_asmso(self):
        html = _render_template(expected_output_dict, "awaiting_svc_mgmt_sign_off")
        expected_response = open("jira_receiver/unit_tests/test_emails/test_email_asmso.html", "r").read()
    ...
    def test_renders_blank_template_if_empty_model_asmso(self):
        html = _render_template(expected_empty_output_dict, "awaiting_svc_mgmt_sign_off")
        expected_response = open("jira_receiver/unit_tests/test_emails/test_email_empty_asmso.html", "r").read()
